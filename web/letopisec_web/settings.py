...
# nginx стоит перед Django и передаёт схему через X-Forwarded-Proto — без этого
# request.build_absolute_uri() (используется в VK/Yandex OAuth) считает соединение HTTP
...
MIDDLEWARE = [
    ...
    "accounts.middleware.CaptureSourceMiddleware",
